...
function attachDelegateEvent_(element, eventName) {
	...
	if (!data.delegating[eventName]) {
		data.delegating[eventName] = {
			handle: on$1(element, eventName, handleDelegateEvent_, !!USE_CAPTURE[eventName]),
			selectors: {}
		};
	}
}
 ...
 */
function on$1(element, eventName, callback, opt_capture) {
	if (isString(element)) {
 ...
 * @return {!DomEventHandle} Can be used to remove the listener.
 */
function once$1(element, eventName, callback) {
	var domEventHandle = on$1(element, eventName, function () {
...
var DomEventEmitterProxy = function (_EventEmitterProxy) {
		...
		value: function addListener_(event, listener) {
			if (this.originEmitter_.addEventListener) {
				if (this.isDelegateEvent_(event)) {
					...
					return on$1(this.originEmitter_, event, listener);
				}
			} else {
				return get$1(DomEventEmitterProxy.prototype.__proto__ || Object.getPrototypeOf(DomEventEmitterProxy.prototype), 'addListener_', this).call(this, event, listener);
			}
		}
   ...
   */
		...
		key: 'shouldProxyEvent_',
		value: function shouldProxyEvent_(event) {
			return get$1(DomEventEmitterProxy.prototype.__proto__ || Object.getPrototypeOf(DomEventEmitterProxy.prototype), 'shouldProxyEvent_', this).call(this, event) && this.isSupportedDomEvent_(event);
		}
	}]);
...
var globalEval = function () {
   ...
   */
		...
		value: function runFile(src, opt_callback, opt_appendFn) {
			...
			once$1(script, 'load', callback);
			once$1(script, 'error', callback);
   ...
   */
		...
		value: function runStyle(style, opt_callback, opt_appendFn) {
			...
			if (style.tagName === 'STYLE') {
				...
				once$1(style, 'load', callback);
				once$1(style, 'error', callback);
			}
...
function parse$2(routeOrTokens) {
	if (!core$1.isString(routeOrTokens)) {
...
var Screen = function (_Cacheable) {
  ...
  */
   ...
   */
		...
		key: 'disposeInternal',
		value: function disposeInternal() {
			get$1(Screen.prototype.__proto__ || Object.getPrototypeOf(Screen.prototype), 'disposeInternal', this).call(this);
			void 0;
		}
...
var App$1 = function (_EventEmitter) {
  ...
  */
   ...
   */
		...
		_this.appEventHandlers_.add(on$1(globals.window, 'scroll', debounce(_this.onScroll_.bind(_this), 100)), on$1(globals.window, 'load', _this.onLoad_.bind(_this)), on$1(globals.window, 'popstate', _this.onPopstate_.bind(_this)));
  ...
  */
   ...
   */
		...
		value: function disposeInternal() {
			...
			get$1(App.prototype.__proto__ || Object.getPrototypeOf(App.prototype), 'disposeInternal', this).call(this);
		}
...
var HtmlScreen = function (_RequestScreen) {
  ...
  */
	...
	createClass(HtmlScreen, [{
		key: 'activate',
		value: function activate() {
			get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'activate', this).call(this);
   ...
   */
		...
		value: function disposeInternal() {
			...
			get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'disposeInternal', this).call(this);
		}
   ...
   */
		...
		value: function evaluateScripts(surfaces) {
			...
			return evaluateTrackedScripts.then(function () {
				return get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'evaluateScripts', _this2).call(_this2, surfaces);
			});
		}
   ...
   */
		...
		value: function evaluateStyles(surfaces) {
			...
			return evaluateTrackedStyles.then(function () {
				return get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'evaluateStyles', _this3).call(_this3, surfaces);
			});
		}
   ...
   */
		...
		value: function flip(surfaces) {
			...
			return get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'flip', this).call(this, surfaces).then(function () {
   ...
   */
		...
		value: function load(path) {
			...
			return get$1(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), 'load', this).call(this, path).then(function (content) {
