...
function preventDOMException18() {
	globals.window.history.pushState = function(...args) {
		syncRetryOperation(originalPushState, args, 30000);
	};

	globals.window.history.replaceState = function(...args) {
		syncRetryOperation(originalReplaceState, args, 30000);
	};
}

function unPreventDOMException18() {
